	...
	const [listQuestions, setListQuestions] = useState([
		{
			...
			parts: [
				{
					text: 'Xin chào. Tôi là shop điện thoại DBIZ , bạn cần chúng tôi tư vấn về sản phẩm gì?',
				},
			],
		},
	] as GoogleChat[]);
	...
	return (
		<PageWrapper>
			<Subheader>
				{/* <SubheaderLeft>
					<img
						src='https://storage.googleapis.com/protonx-cdn/IOExtended2024-logos-07%20(1).png'
						width='150'
					/>
				</SubheaderLeft> */}
				<SubheaderRight>
